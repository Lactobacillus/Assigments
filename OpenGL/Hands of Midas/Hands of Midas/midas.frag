...
void main () {
   ...
   //for original
   vec3 handcolor = vec3(1.0,0.7, 0.45);
   vec3 diffuse2 = (cos * lightcolor * handcolor * lightpower) / (distance * distance);
   ...
   //for original
   vec3 ambient2 =  ambientstrength * lightcolor * handcolor;
   ...
   vec4 original = vec4((diffuse2 + ambient2), 1.0);
   ...
   if (render2 == 1) beforeColor = iceColor;
   if (render2 == 2) beforeColor = tooncolor;
   if (render2 == 3) beforeColor = goldColor;
   if (render2 == 4) beforeColor = metalColor;
   if (render2 == 5) beforeColor = glassColor;

   if (render1 == 0) afterColor = original;
   if (render1 == 1) afterColor = iceColor;
   if (render1 == 2) afterColor = tooncolor;
   if (render1 == 3) afterColor = goldColor;
   if (render1 == 4) afterColor = metalColor;
   if (render1 == 5) afterColor = glassColor;
